...
const SERVER_INFO = { name: "artifact-mcp", version: "1.10.0" };
...
function feedbackJson(f) {
  return {
    ...
    anchor_kind: f.anchor_kind ?? null,
    anchor_node_id: f.anchor_node_id ?? null,
    anchor_quote: f.anchor_quote ?? null,
    anchor_version: Number.isInteger(f.anchor_version)
      ? f.anchor_version
      : f.anchor_kind != null || f.anchor_node_id != null || f.anchor_quote != null
        ? 2
        : f.anchor_x != null && f.anchor_y != null
          ? 1
          : 0,
